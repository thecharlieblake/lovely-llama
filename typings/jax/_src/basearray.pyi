...
class Array(abc.ABC):
  ...
  def mean(self, axis: int | Sequence[int] | None = None, dtype: DTypeLike | None = None,
           out: None = None, keepdims: bool = False, *, where: ArrayLike | None = None,) -> Array: ...
  ...
  def reshape(self, *args: ArrayLike, order: str = 'C') -> Array: ...
  ...
  def sum(self, axis: int | Sequence[int] | None = None, dtype: DTypeLike | None = None,
          out: None = None, keepdims: bool | None = None, initial: ArrayLike | None = None, where: ArrayLike | None = None) -> Array: ...
...
StaticScalar = Union[
  np.bool_, np.number[Any],  # NumPy scalar types
  bool, int, float, complex,  # Python scalar types
]

ArrayLike = Union[
  Array,  # JAX array type
  np.ndarray[Any, Any],  # NumPy array type
